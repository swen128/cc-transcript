/**
 * JavaScript for Claude Code transcripts
 *
 * Extracted from simonw/claude-code-transcripts Python package
 * DO NOT MODIFY - must match original for pixel-perfect output
 */

/**
 * Main JavaScript for timestamp formatting, JSON syntax highlighting, and truncation
 */
export const JS = `
...
/**
 * Search JavaScript template
 * Generates the search modal functionality for the index page
 */
